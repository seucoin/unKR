...
def main(arg_path):
    print('This demo is for testing BEUrRE')
    ...
    if not args.test_only:
        ...
        path = "./output/confidence_prediction/ppi5k/BEUrRE/epoch=24-Test_MSE=0.00000.ckpt"
...
if __name__ == "__main__":
    main(arg_path='../config/ppi5k/BEUrRE_ppi5k.yaml')
